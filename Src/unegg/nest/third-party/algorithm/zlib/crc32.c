...
/* ========================================================================= */
unsigned int ZEXPORT crc32(unsigned int crc, const unsigned char FAR *buf, uInt len)
{
...
/* ========================================================================= */
local unsigned int crc32_little(unsigned int crc, const unsigned char FAR *buf, unsigned len)
{
    register u4 c;
...
/* ========================================================================= */
local unsigned int crc32_big(unsigned int crc, const unsigned char FAR *buf, unsigned len)
{
    register u4 c;
    register const u4 FAR *buf4;
